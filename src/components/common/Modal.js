...
function RatingModal({ children }) {
  ...
  return (
    <>
      <button
        className="border border-pink-500 text-pink-500 hover:text-pink-400 px-4 py-1 rounded-lg"
        type="button"
        onClick={handleRatingModal}
      >
        {user ? "Leave a rating." : "Login to to give rating."}
      </button>
              ...
              <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button
                  onClick={() => {
                    ...
                    toast.success(
                      "Thanks for your rating. It eill appear soon."
                    );
                  }}
                  type="button"
